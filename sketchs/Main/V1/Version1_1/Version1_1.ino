...
void loop() {
  ...
  if (millis() - timer > 1000) { 
    ...
    //date = dateutc(GPS.year,GPS.month,GPS.day,GPS.hour,utc);
    ...
    if (n == 0){
      ...
      display.print("Time: ");
      if (GPS.hour <10) display.print('0'); display.print(GPS.hour, DEC); display.print(':');
      ...
      if (m == 0){
        display.println("Mode Run");display.println(utc);
      }
      if (m == 1){
