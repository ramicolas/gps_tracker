// VERSION 1.2  programed for Arduino Uno/Nano  not including sd cards (lack of memory space)
...
// ****** EVERY SECOND *******
  ...
  if (millis() - timer > 1000) { 
    ...
    if (n==1 && m==0 && GPS.fix){
      ...
      // PACEinst
      // if p ==1 : CALCULATE inst PACE from last distance where p == 1 and then reinitialize
      ...
      // save date and coordinates in SD card
