// Version 1.6 light version of 1.3 with Julian display. Modified to run on Arduino Leonardo/Micro. Saving coordinates in txt files as a gpx file (have to then modifies the name)
